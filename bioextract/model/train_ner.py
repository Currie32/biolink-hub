...
def train_ner(
    ...
    print(f"  [NER] Config: {len(examples)} examples, {epochs} epochs, batch_size={batch_size}, gpu={device_is_gpu}", flush=True)
    print(f"  [NER] Loading PubMedBERT tokenizer and model...", flush=True)
